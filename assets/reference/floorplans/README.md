# Dorm suite floor plan reference

## `dorm-suite-floorplan.png`

- Supplied by the user on 2026-09-16.
- Intended as the structural reference for the first reconstruction test.
- The drawing shows a mirrored two-bedroom dorm suite with two bathrooms and a shared central living/kitchen area.
- The image currently has no confirmed scale, wall height, or authoritative dimensions. Do not infer metric geometry from image pixels alone.
- Use the plan first to build a parametric shell. Use measurements and room photographs later to resolve scale, height, openings, fixed furniture, materials, and movable objects.

## Initial reconstruction scope and measurements
